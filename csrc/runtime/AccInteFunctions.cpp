...
// LITERALINCLUDE START: ACCINTE SetDevice FUNCTION
...
// LITERALINCLUDE END: ACCINTE SetDevice FUNCTION
...
// LITERALINCLUDE START: ACCINTE set_device FUNCTION
ACCINTE_EXPORT void set_device(DeviceIndex device) {
  check_device_index(device);
  ACCINTE_CHECK(SetDevice(device));
}
// LITERALINCLUDE END: ACCINTE set_device FUNCTION
