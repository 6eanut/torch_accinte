...
// LITERALINCLUDE START: ACCINTE GET DEFAULT GENERATOR IMPL
const at::Generator& getDefaultAccInteGenerator(c10::DeviceIndex device_index) {
  static bool flag [[maybe_unused]] = []() {
    auto deivce_nums = device_count();
    default_generators.resize(deivce_nums);
    for (auto i = 0; i < deivce_nums; i++) {
      default_generators[i] = at::make_generator<AccInteGeneratorImpl>(i);
...
// LITERALINCLUDE END: ACCINTE GET DEFAULT GENERATOR IMPL
