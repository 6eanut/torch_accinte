#include "AccInteSerialization.h"

namespace c10::accinte {
struct AccInteBackendMeta : public c10::BackendMeta {
  AccInteBackendMeta(int version_number, int format_number)
...
void for_serialization(
  ...
  if (meta_ptr != nullptr) {
    auto o_meta_ptr = dynamic_cast<AccInteBackendMeta*>(meta_ptr);
...
void for_deserialization(
  ...
  c10::intrusive_ptr<c10::BackendMeta> meta{std::unique_ptr<c10::BackendMeta>(
      new AccInteBackendMeta(version_number, format_number))};
