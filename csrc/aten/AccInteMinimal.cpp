...
at::Tensor wrapper_empty_memory_format(
  ...
  return at::native::accinte::empty_memory_format(
      size,
      dtype_opt,
      layout_opt,
      device_opt,
...
at::Tensor wrapper_empty_strided(
    ...
    std::optional<c10::Device> device_opt,
    std::optional<bool> pin_memory_opt) {
  return at::native::accinte::empty_strided(
...
at::Tensor wrapper_as_strided(
  ...
  return at::native::accinte::as_strided(self, size, stride, storage_offset);
}
...
const at::Tensor& wrapper_resize_(
  ...
  return at::native::accinte::resize_(self, size, memory_format);
}
...
at::Tensor wrapper__reshape_alias(
    ...
    c10::SymIntArrayRef size,
    c10::SymIntArrayRef stride) {
  return at::native::accinte::_reshape_alias(self, size, stride);
}
...
at::Tensor wrapper__copy_from(
    ...
    const at::Tensor& dst,
    bool non_blocking) {
  return at::native::accinte::_copy_from(self, dst, non_blocking);
}

at::Tensor wrapper__copy_from_and_resize(
    const at::Tensor& self,
    const at::Tensor& dst) {
  return at::native::accinte::_copy_from_and_resize(self, dst);
}

at::Scalar wrapper__local_scalar_densor(const at::Tensor& self) {
  return at::native::accinte::_local_scalar_dense(self);
}

at::Tensor& wrapper_set_source_Tensor_(
    at::Tensor& self,
    const at::Tensor& source) {
  return at::native::accinte::set_source_Tensor_(self, source);
}

at::Tensor& wrapper_set_source_Storage_(at::Tensor& self, at::Storage source) {
  return at::native::accinte::set_source_Storage_(self, source);
}
...
void wrapper_cpu_fallback(
  ...
  at::native::accinte::cpu_fallback(op, stack);
}
