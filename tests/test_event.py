...
class TestEvent(TestCase):
    ...
    def test_event_elapsed_time(self):
        ...
        event1 = torch.Event(device="accinte:1", enable_timing=True)
        event1.record(stream)
        event2 = torch.Event(device="accinte:1", enable_timing=True)
    ...
    def test_event_different_devices(self):
        ...
        event0 = torch.Event(device="accinte:0")
        event1 = torch.Event(device="accinte:1")
    ...
    def test_event_timing_disabled(self):
        ...
        event1 = torch.Event(device="accinte:1", enable_timing=False)
        event2 = torch.Event(device="accinte:1", enable_timing=False)
